<template>
  <el-drawer v-model="drawerVisible" title="布局设置" size="290px">
    ...
    <div class="theme-item">
      <span>菜单手风琴</span>
      <el-switch v-model="accordion" @change="globalStore.saveSettings" />
    </div>
    <div class="theme-item">
      <span>水印</span>
      <el-switch v-model="watermark" @change="globalStore.saveSettings" />
    </div>
    <div class="theme-item">
      <span>面包屑</span>
      <el-switch v-model="breadcrumb" @change="globalStore.saveSettings" />
    </div>
    <div class="theme-item">
      <span>面包屑图标</span>
      <el-switch v-model="breadcrumbIcon" @change="globalStore.saveSettings" />
    </div>
    <div class="theme-item">
      <span>标签栏</span>
      <el-switch v-model="tabs" @change="globalStore.saveSettings" />
    </div>
    <div class="theme-item">
      <span>标签栏图标</span>
      <el-switch v-model="tabsIcon" @change="globalStore.saveSettings" />
    </div>
    <div class="theme-item">
      <span>页脚</span>
      <el-switch v-model="footer" @change="globalStore.saveSettings" />
    </div>
  </el-drawer>
</template>
...
const { layout, primary, isGrey, isWeak, isCollapse, accordion, watermark, breadcrumb, breadcrumbIcon, tabs, tabsIcon, footer } =
